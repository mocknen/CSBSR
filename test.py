...
def test(args, cfg):
    ...
    if args.tti_crack_dataset:
        test_dataset = TTICrackDataSetTest(cfg, cfg.DATASET.TEST_IMAGE_DIR,
                                           args.batch_size,
                                           transforms=test_transforms, )
    elif 'RetinalSeg' in cfg.DATASET.TEST_IMAGE_DIR:
        test_dataset = RetinalDataSetTest(cfg, cfg.DATASET.TEST_IMAGE_DIR,
                                          cfg.DATASET.TEST_MASK_DIR,
                                          cfg.DATASET.TEST_BLURED_DIR,
                                          cfg.DATASET.TEST_BLURED_NAME,
                                          args.batch_size,
                                          transforms=test_transforms,
                                          sr_transforms=sr_transforms)
    else:
        test_dataset = CrackDataSetTest(cfg, cfg.DATASET.TEST_IMAGE_DIR,
                                        cfg.DATASET.TEST_MASK_DIR,
                                        cfg.DATASET.TEST_BLURED_DIR,
                                        cfg.DATASET.TEST_BLURED_NAME,
                                        args.batch_size,
    ...
    batch_sampler = BatchSampler(sampler=sampler, batch_size=args.batch_size,
                                 drop_last=False)
